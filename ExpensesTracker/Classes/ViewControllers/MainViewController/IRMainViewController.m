...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    switch (section) {
        case 0:
            ...
            if (trackMode.intValue == 0) {
                cell.textLabel.text = [NSString stringWithFormat:@"Current month: %@",[IRCommon getCurrentMonth]];
                cell.textLabel.textColor = [IRCommon getThemeColor];
            } else {
                cell.textLabel.text = [NSString stringWithFormat:@"Current month: %@ %@",[IRCommon getCurrentMonth],(profitForCurrentMonth > 0) ? @"⬆︎" : @"⬇︎"];
        ...
        case 1:
            ...
            cell.textLabel.text = @"Categories of expense:";
        ...
        case 2:
            ...
            cell.textLabel.text = @"Categories of income:";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 1) {
        ...
        expenseString = [NSString stringWithFormat:@"- %@",category];
