...
- (NSArray *)getArrayOfOverViewText
{
    ...
    if (totalExpenseForMonth > 0 && totalIncomeForMonth > 0) {
        if (profit > 0) {
            [overViewTextArray addObject:[NSString stringWithFormat:[IRCommon localizeText:@"You saved money in the month of %@."],[IRCommon getCurrentMonth]]];
            ...
            [overViewTextArray addObject:[NSString stringWithFormat:[IRCommon localizeText:@"You spend money extra in the month of %@."],[IRCommon getCurrentMonth]]];
            //[overViewTextArray addObject:[NSString stringWithFormat:@"You spend %@ %0.2f in the month of %@",[IRCommon getCurrencySymbolFromCode:[[NSUserDefaults standardUserDefaults]objectForKey:@"currency"]],totalExpenseForMonth,[IRCommon getCurrentMonth]]];
            //[overViewTextArray addObject:[NSString stringWithFormat:@"You earned %@ %0.2f in the month of %@",[IRCommon getCurrencySymbolFromCode:[[NSUserDefaults standardUserDefaults]objectForKey:@"currency"]],totalIncomeForMonth,[IRCommon getCurrentMonth]]];
        }
        ...
        [overViewTextArray addObject:[NSString stringWithFormat:[IRCommon localizeText:@"You earned money in the month of %@"],[IRCommon getCurrentMonth]]];
        ...
        [overViewTextArray addObject:[NSString stringWithFormat:[IRCommon localizeText:@"You spend money in the month of %@"],[IRCommon getCurrentMonth]]];
    } else {
